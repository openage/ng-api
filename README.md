# ng-api
[![Build Status](https://travis-ci.org/robisim74/ng-api.svg?branch=master)](https://travis-ci.org/robisim74/ng-api)
...
Get the [Changelog](https://github.com/robisim74/ng-api/blob/master/CHANGELOG.md).
...
2. Rename `ng-api` and `angularLibraryStarter` everywhere to `my-library` and `myLibrary`. Also customize the `license-banner.txt` file.
...
1. `package.json`
    ...
    * `"main": "./bundles/ng-api.umd.js"` legacy module format 
    * `"module": "./esm5/ng-api.js"` flat _ES_ module, for using module bundlers such as _Rollup_ or _webpack_: 
    [package module](https://github.com/rollup/rollup/wiki/pkg.module)
    * `"es2015": "./esm2015/ng-api.js"` _ES2015_ flat _ESM_ format, experimental _ES2015_ build
...
## Previous versions
- **Angular v4**
    - [Branch](https://github.com/robisim74/ng-api/tree/angular_v4)

- **Angular v2**
    - [Branch](https://github.com/robisim74/ng-api/tree/angular_v2)
